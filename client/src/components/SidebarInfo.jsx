    ...
    if (this.state.isLoading) {
      ...
      return (
        <div className="sidebar-info-container">
          <div className="sidebar-info-map-container">
            <iframe className="sidebar-info-map" src={this.state.map}></iframe>
            <div className="sidebar-info-map-node">
              <div className="sidebar-info-svg">
          ...
          <div>
            <a className="sidebar-info-view-more" onClick={() => this.handleView()}>+ View more</a>
          </div>
        </div>
      );
    } else {
      return (
        <div className="sidebar-info-container">
          ...
          <div>
            <a className="sidebar-info-view-more" onClick={() => this.handleView()}>- View less</a>
          </div>
        </div>
      )
    }
